  ...
  return (
    ...
    >
      <div
        ...
        } shadow transition-all duration-200 today-card h-full bg-[#FFFFFF] rounded-xl relative overflow-hidden flex items-end`}
      >
        <div
          id="today-card-info"
        ...
        <div
          ...
          style={{
            background:
              "url('https://cdn.discordapp.com/attachments/909799586195976239/1153894057148436560/pexels-alexander-kovalev-2847648.jpg') no-repeat center /cover"
          }}
        ></div>
      </div>
    </div>
