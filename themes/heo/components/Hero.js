  ...
  return (
    ...
    >
      <div
        ...
        }shadow duration-200 today-card h-full bg-[#202935] rounded-xl relative overflow-hidden flex items-end`}
      >
        <div
          id="today-card-info"
        ...
        >
          ...
          <div
            ...
            } flex items-center px-3 h-10 bg-[#425aef] justify-center hover: bg-[#4259efcb] transition-colors duration-100 rounded-3xl`}
          >
            <PlusSmall
        ...
        <div
          ...
          style={{
            background:
              "url('https://cdn.discordapp.com/attachments/909799586195976239/1153975989630668860/image.png?ex=6603dd63&is=65f16863&hm=b9248ab2cf00298793f4ec5892f2edaa1b5f6b7c743360e910d37343eb79882e&') no-repeat center /cover"
          }}
        ></div>
      </div>
    </div>
